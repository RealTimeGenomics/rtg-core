...
//  }
  ...
  public void testWriteProtein() throws IOException {
    ...
    try {
      ActionsHelper.writeProtein(bos, GotohProteinEditDistanceTest.encodeProteins("ACDE"), 0, cycle(4), ActionsHelper.INSERTION_INTO_REFERENCE);
    } finally {
      bos.close();
    }
  ...
  public void testWriteProteinLong() throws IOException {
    ...
    try {
      ...
      ActionsHelper.writeProtein(bos, GotohProteinEditDistanceTest.encodeProteins(prot), 0, cycle(prot.length()), ActionsHelper.INSERTION_INTO_REFERENCE);
    } finally {
      bos.close();
    }
  ...
  public void testWriteProteinOffArray() throws IOException {
    final ByteArrayOutputStream bos = new ByteArrayOutputStream();
    try {
      ActionsHelper.writeProtein(bos, GotohProteinEditDistanceTest.encodeProteins("E"), -2, cycle(5), ActionsHelper.INSERTION_INTO_REFERENCE);
    } finally {
      bos.close();
    }
  ...
  public void testWriteMatches1() throws IOException, InvalidParamsException {
    final ByteArrayOutputStream bos = new ByteArrayOutputStream();
    final byte[] p = GotohProteinEditDistanceTest.encodeProteins("ACDE");
    try {
  ...
  public void testWriteMatches2() throws IOException, InvalidParamsException {
    ...
    final byte[] p = GotohProteinEditDistanceTest.encodeProteins("ARNDCQEGHILKMFPSTWYV*");
    final ByteArrayOutputStream bos = new ByteArrayOutputStream();
    try {
  ...
  public void testWriteMatches3() throws IOException, InvalidParamsException {
    ...
    final ByteArrayOutputStream bos = new ByteArrayOutputStream();
    try {
      assertEquals(3, ActionsHelper.writeProteinMatches(bos, GotohProteinEditDistanceTest.encodeProteins("ACDE"), GotohProteinEditDistanceTest.encodeProteins("QFCDD"), sb, new ProteinScoringMatrix()));
    } finally {
      bos.close();
    }
