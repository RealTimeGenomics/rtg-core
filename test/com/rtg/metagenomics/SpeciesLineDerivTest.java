...
/**
 */
public class SpeciesLineDerivTest extends TestCase {
  ...
  public void test() {
    ...
    final Line spl = new SpeciesLineDeriv(r, d, bi);
    ...
    assertEquals(0.27128, values[1], 1e-5);


    final double[] val1 = spl.values(1.0);
    assertEquals(2, val1.length);
    assertEquals(-0.51408, val1[0], 1e-5);
    assertEquals(0.23065, val1[1], 1e-5);
  }
