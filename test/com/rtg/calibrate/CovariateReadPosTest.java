...
/**
 */
public class CovariateReadPosTest extends TestCase {


  public void testSam() throws BadSuperCigarException {
    final Covariate var = new CovariateReadPos(15);
  ...
  public void testResize() throws BadSuperCigarException {
    final Covariate var = new CovariateReadPos(6);
  ...
  public void testNameType() {
    final Covariate var = new CovariateReadPos(15);
    assertEquals("readposition:15", var.name());
    assertEquals(CovariateEnum.READPOSITION, var.getType());
  }
}
