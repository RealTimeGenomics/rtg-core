...
public class BaseQualityPhredScalerTest extends TestCase {
  ...
  public void testABunch() throws Exception {
    ...
    try {
      ...
      assertEquals(13, bqps.getScaledPhred((byte) 0, 0, Arm.LEFT));
      assertEquals(15, bqps.getScaledPhred((byte) 1, 0, Arm.LEFT));
      assertEquals(2, bqps.getScaledPhred((byte) 2, 0, Arm.LEFT));
      assertEquals(2, bqps.getScaledPhred((byte) 200, 0, Arm.LEFT));
    } finally {
