...
public class PosteriorContaminatedTest extends TestCase {
  ...
  private AbstractPosterior getContaminatedPosterior(double contamination) {
    ...
    final ContaminatedSomaticCaller cc = new ContaminatedSomaticCaller(CombinedPriorsSnp.makeQ(0.001, 0.0, hypotheses), CombinedPriorsSnp.makeQ(0.001, 0.0, hypotheses), null);
    cc.integrity();
