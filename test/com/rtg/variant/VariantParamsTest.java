...
public class VariantParamsTest extends TestCase {
  ...
  public void testDefaultsWithNonIdentityPosterior() {
    ...
    TestUtils.containsAll(params.toString(),
        ...
        " max_coverage_filter=2147483647" + LS,
        " max_coverage_bypass=2147483647" + LS,
        ...
        " somaticRate=0.3 includeGermlineVariants=false includeGainOfReference=false lohPrior=0.0" + LS,
        " contraryProbability=1.0E-4" + LS,
