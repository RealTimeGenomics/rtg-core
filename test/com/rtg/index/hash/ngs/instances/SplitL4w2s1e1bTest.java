...
/**
 */
public class SplitL4w2s1e1bTest extends AbstractSplitTest {
  ...
  private static final String EXPECTED_1 = ""
    ...
    + " hash=00000000:00000000:00000000:00000000:00000000:00000000:00000000:00001001" + StringUtils.LS
  ...
  public void testFactory() {
    assertEquals(4, SplitL4w2s1e1b.FACTORY.hashBits());
    assertEquals(4, SplitL4w2s1e1b.FACTORY.windowBits());
    assertEquals(3, SplitL4w2s1e1b.FACTORY.numberWindows());
    final NgsHashFunction hf = SplitL4w2s1e1b.FACTORY.create(new ReadCallMock(null), new TemplateCallMock(null));
    assertTrue(hf != null);
    assertTrue(hf instanceof SplitL4w2s1e1b);
    assertEquals(hf.numberWindows(), SplitL4w2s1e1b.FACTORY.numberWindows());
  }
}
