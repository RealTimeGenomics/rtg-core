...
public class IndexSimpleTest extends AbstractIndexTest {
  ...
  protected IndexBase getIndex(final long size, final int hashBits, final Integer threshold) {
    return new IndexSimple(new CreateParams(size, hashBits, hashBits, 31, false, true, false, false), new RepeatFrequencyFilterMethod(threshold, false, threshold, threshold), 1);
  }
