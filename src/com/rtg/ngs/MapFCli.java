...
public class MapFCli extends ParamsCli<NgsParams> {
  ...
  protected static void initFlags(CFlags flags) {
    ...
    flags.setDescription("Filters reads for contaminant sequences by mapping them against the contaminant template. It outputs two SDF files, one containing the input reads that map to the template and one that contains those that do not.");
