...
public class GraphMapCli extends ParamsCli<GraphMapParams> {
  ...
  protected static void initCommonFlags(CFlags flags) {
    ...
    final Flag reads454 = flags.registerOptional('f', FOUR_FIVE_FOUR, File.class, "Dir", "SDF containing 454 reads").setCategory(INPUT_OUTPUT);
    final Flag listFlag454 = flags.registerOptional('F', INPUT_LIST_FLAG_454, File.class, "FILE", "file containing a list of SDF directories (1 per line) containing 454 sequences to assemble").setCategory(INPUT_OUTPUT);
    reads454.setMinCount(0);
    reads454.setMaxCount(Integer.MAX_VALUE);
    final Flag readsMatePair = flags.registerOptional('j', MATE_PAIR, File.class, "Dir", "SDF containing mate pair reads").setCategory(INPUT_OUTPUT);
    final Flag listFlagMatePair = flags.registerOptional('J', INPUT_LIST_FLAG_MATE_PAIR, File.class, "FILE", "file containing a list of SDF directories (1 per line) containing mate pair sequences to assemble").setCategory(INPUT_OUTPUT);
