...
public class CnvProductCli extends ParamsCli<CnvProductParams> {
  ...
  protected void initFlags() {
    ...
    final Flag inFlag = mFlags.registerOptional('i', INPUT_BASELINE_FLAG, File.class, "FILE", "SAM/BAM format files containing mapped reads for baseline");
    inFlag.setCategory(INPUT_OUTPUT);
    inFlag.setMinCount(0);
    inFlag.setMaxCount(Integer.MAX_VALUE);
    inFlag.setPsuedoMinMaxRangeString(0, Constants.MAX_OPEN_FILES);
    final Flag inFlag2 = mFlags.registerOptional('j', INPUT_TEST_FLAG, File.class, "FILE", "SAM/BAM format files containing mapped reads for test");
    ...
    final Flag listFlag1 = mFlags.registerOptional('I', INPUT_BASELINE_LIST_FLAG, File.class, "FILE", "file containing list of SAM/BAM format files (1 per line) containing mapped reads for baseline").setCategory(INPUT_OUTPUT);
    final Flag listFlag2 = mFlags.registerOptional('J', INPUT_TEST_LIST_FLAG, File.class, "FILE", "file containing list of SAM/BAM format files (1 per line) containing mapped reads for test").setCategory(INPUT_OUTPUT);
