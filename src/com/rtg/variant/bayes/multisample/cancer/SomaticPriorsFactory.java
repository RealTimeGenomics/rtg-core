...
class SomaticPriorsFactory<D extends Description> {
   ...
   */
  SomaticPriorsFactory(final Hypotheses<D> hypotheses, final double loh, final double[][] initialPriors) {
   ...
   * @param loh probability of loss of heterozygosity.
   */
  SomaticPriorsFactory(final Hypotheses<D> hypotheses, final double loh) {
