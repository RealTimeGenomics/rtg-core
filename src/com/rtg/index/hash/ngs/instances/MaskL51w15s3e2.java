 ...
 * <tr>  <td> 0000000111</td> <td> 0</td> <td> 1</td> </tr>
 * <tr>  <td> 0000001110</td> <td> 1</td> <td> 1</td> </tr>
 * <tr>  <td> 0000011100</td> <td> 2</td> <td> 1</td> </tr>
 * <tr>  <td> 0000111000</td> <td> 3</td> <td> 1</td> </tr>
 * <tr>  <td> 0001110000</td> <td> 4</td> <td> 1</td> </tr>
 * <tr>  <td> 0011100000</td> <td> 5</td> <td> 1</td> </tr>
 * <tr>  <td> 0111000000</td> <td> 6</td> <td> 1</td> </tr>
 * <tr>  <td> 1110000000</td> <td> 7</td> <td> 1</td> </tr>
 * <tr>  <td> 0001001001</td> <td> 8</td> <td> 1</td> </tr>
 * <tr>  <td> </td> <td> 9</td> <td> 9</td> </tr>
 * </table>
 *
 */
public class MaskL51w15s3e2 extends ImplementHashFunction {
  ...
  private static final int NUMBER_WINDOWS = 9;
   ...
   */
  public MaskL51w15s3e2(final ReadCall readCall, final TemplateCall templateCall) {
  ...
  public void readAll(final int readId, long v0, long v1) {
    ...
    final long l5 =
    ((v0 >> 25) & ((1L << 15) - 1L)) | (((v1 >> 25) & ((1L << 15) - 1L)) << 15);
    mReadCall.readCall(readId, hash(l5), 5);

    final long l6 =
    ((v0 >> 30) & ((1L << 15) - 1L)) | (((v1 >> 30) & ((1L << 15) - 1L)) << 15);
    mReadCall.readCall(readId, hash(l6), 6);

    final long l7 =
    ((v0 >> 35) & ((1L << 15) - 1L)) | (((v1 >> 35) & ((1L << 15) - 1L)) << 15);
  ...
  public void toString(final StringBuilder sb) {
    sb.append("MaskL51w15s3e2 l=" + LENGTH + " w=" + NUMBER_NT + " s=3 e=2");
  }
}
