 ...
 */
public class CGMaska15b1alt extends AbstractCGMask {
   ...
   */
  static class CG15HashFunctionFactory implements CGHashFunctionFactory {
    @Override
   ...
   */
  public CGMaska15b1alt(final ReadCall readCall, final TemplateCall templateCall) {
